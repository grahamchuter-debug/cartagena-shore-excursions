    ...
    <>
      ...
      <section className="section-padding">
        <div className="container-wide max-w-4xl">
          ...
          {isPremium && (
            <>
              <div className="mt-10 card-editors-choice">
                ...
                <p className="mt-2 text-sm text-gray-600">Our editorial team compared ship tours, DIY options and independent operators before naming Roman Highlights Editor&apos;s Choice — not marketing, but the excursion we would genuinely suggest for first-time visitors.</p>
                <ul className="mt-4 list-disc space-y-2 pl-5 text-sm text-gray-700">
                  {e.whyWeRecommend!.map((x) => <li key={x}>{x}</li>)}
                </ul>
                <Link href="/why-roman-highlights-is-our-editors-choice" className="btn-secondary mt-4 inline-flex text-sm">Read our full editorial reasoning</Link>
              </div>
          ...
          <div className="mt-8 card-accent">
            <h2 className="font-display text-xl font-bold text-gray-900">Port logistics from Muelle Alfonso XII</h2>
